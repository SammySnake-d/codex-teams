...
pub(crate) struct AgentControl {
    ...
    /// Codex Teams registry, scoped like `state` to this agent-control tree.
...
impl AgentControl {
    ...
    /// Shared Codex Teams registry for this agent-control tree. Used by gated
    /// team tool handlers from lead/top-level sessions.
